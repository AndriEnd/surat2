					...
					<div class="card-body">
						<div class="row">
							...
							<div class="col-md-6 col-lg-6">
								...
								<div class="form-group">
									<label>RT / RW</label>
									<input type="text" name="status_warga" value="<?php echo $status_warga; ?>" class="form-control" placeholder="RT / RW">
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<input type="text" name="keperluan" value="<?php echo $keperluan; ?>" class="form-control" placeholder="Telepon Anda.." readonly="">
								</div>
							</div>
						</div>
					</div>
