			...
			<form method="POST" enctype="multipart/form-data">
				<div class="card">
					<div class="card-header">
						<div class="card-title">FORM LAYANAN SURAT KETERANGAN USAHA</div>
					</div>
					<div class="card-body">
						<div class="row">
							<div class="col-md-6 col-lg-6">
								...
								<div class="form-group">
									...
									<input type="text" name="jenis_usaha" class="form-control" placeholder="jenis Usaha.." autofocus>
								</div>
								<div class="form-group">
									<label>Alamat Usaha</label>
									<input type="text" name="alamat_usaha" class="form-control" placeholder="Alamat Usaha" autofocus>
								</div>
								<div class="form-group">
									<label>Status Kepemilikan</label>
									<input type="text" name="kepemilikan" class="form-control" placeholder="Kepemilikan" autofocus>
								</div>
							</div>
							<div class="col-md-6 col-lg-6">
								<div class="form-group">
